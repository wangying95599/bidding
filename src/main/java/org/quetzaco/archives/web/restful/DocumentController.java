...
import org.quetzaco.archives.util.watermark.WaterMarkImageWithSignRunner;
import org.quetzaco.archives.util.watermark.WaterMarkLargeFontRunner;
...
//            "documentCreateTime":documentCreateTime,
  ...
  public HttpEntity<APIEntity<Documents>> documentSave(@AccessKey @PathVariable("fileId") Long fileId, @PathVariable("type") int type, @RequestBody Documents documents) {
      ...
      documentService.saveDocumentDetailInfo(documents);
...
//    }
  ...
  public HttpEntity<APIEntity<PageInfo>> searchGlobalDocumentList(
          @Param("title") String title,
          @Param("fileCode") String fileCode,
    ...
    document.setArchiveYear(archiveYear);
    return buildEntity(
        APIEntity.create(documentService.searchGlobalDocumentList(document, offset, limit)));
  }
